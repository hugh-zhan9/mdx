...
export const MDX_BLOCK_SELECTOR =
    "[data-mdx-node-type='heading'],[data-mdx-node-type='paragraph'],[data-mdx-node-type='bullet_list'],[data-mdx-node-type='ordered_list'],[data-mdx-node-type='code_block'],[data-mdx-node-type='mermaid_block'],[data-mdx-node-type='blockquote'],[data-mdx-node-type='table'],[data-mdx-node-type='horizontal_rule'],[data-mdx-node-type='frontmatter'],[data-mdx-node-type='opaque']";
