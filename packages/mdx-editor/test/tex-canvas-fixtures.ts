...
export const TEX_CANVAS_FIXTURES: TexCanvasFixture[] = [
    {
        id: "paragraph-cjk",
    ...
    },
    {
        ...
        expected: {
            blockKinds: ["paragraph", "math"],
            canvasBlockKinds: ["math"],
    ...
    },
    {
        id: "html-fallback",
        markdown:
            "<details><summary>x</summary><div>opaque</div></details>\n",
        expected: {
            blockKinds: ["fallback"],
            canvasBlockKinds: ["fallback"],
            lineSnippets: ["<details>", "<summary>x</summary>"],
            mirrorText: "x opaque",
        },
    },
];
